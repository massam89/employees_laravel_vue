            ...
            <div class="row justify-content-center">
                <div class="col-md-8">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <a href="{{ route('users.index') }}" class="float-right btn">Back</a>
                    ...
                    <form class="m-2 p-2" action="{{ route('users.destroy', $user->id) }}" method="POST">
                        @csrf
                        @method('DELETE')
                ...
                <div class="col-md-8">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ route('users.change.passoword', $user->id) }}">
                                @csrf
